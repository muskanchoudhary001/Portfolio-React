      ...
      <div className="w-full lg:w-1/2">
        <div className="flex flex-col items-center lg:items-start">
          <motion.h1
            ...
            className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Muskan Choudhary</motion.h1>
          <motion.span
      ...
      <div className="w-full lg:w-1/2 lg:p-8">
        <div className="flex justify-center">
          < motion.img
            ...
            src={profilePic}
            alt="profilePic"
            className="rounded-full w-70 h-90" // Added Tailwind classes for round image
          />
        </div>
      </div>
    </div>
